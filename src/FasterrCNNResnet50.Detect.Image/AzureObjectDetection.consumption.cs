...
namespace FasterrCNNResnet50_Detect_Image
{
    ...
    {
        /// <summary>
        /// model input class for AzureObjectDetection.
        /// </summary>
        ...
        /// <summary>
        /// model output class for AzureObjectDetection.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            public string[] ObjectTags = new string[] { "--bg--", "tennis-ball", };
        ...
        private static string MLNetModelPath = Path.GetFullPath("AzureObjectDetection.mlnet");
